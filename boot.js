var BasicGame = {
  ...
  SPAWN_SHOOTER_DELAY: Phaser.Timer.SECOND * 0.5,
  BOSS_TRIGGER_SCORE: 50000,

  SHOT_DELAY: Phaser.Timer.SECOND * 0.1,
  SHOOTER_SHOT_DELAY: Phaser.Timer.SECOND * 4,
  ...
  PLAYER_EXTRA_LIVES: 7,
  PLAYER_GHOST_TIME: Phaser.Timer.SECOND * 5,
